...
import java.util.*;
import java.io.*;
public class McRonald3Point5
{
   public static final int TIME = 1080;     //18 hrs * 60 min
   public static double CHANCE_OF_CUSTOMER = .5;
   ...
   {     
      ...
      try
      {
         outfile = new PrintWriter(new FileWriter("McRonald 1 Queue 3 ServiceArea point 5.txt"));
      }
      ...
      outfile.println("Mcronald(arrival chance is 0.5) with 1 queue / 3 service areas");
   ...
   public static void mcRonald(int TIME, PrintWriter of)
   {
      ...
      **********************************/
      ...
      for(int i = 0; i < TIME; i++)
      {
         ...
         if(chance < CHANCE_OF_CUSTOMER)        //50% chance of chance to be less than 0.5
         {
