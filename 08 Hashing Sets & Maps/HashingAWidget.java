...
public class HashingAWidget
{
   public static void main(String[] args)
   {
      int num1 = 8;
      int num2 = 16;
      mainCaller(num1, num2);
   }
   
   public static void mainCaller(int num1, int num2)
   {
      Set<Widget> tSet = new TreeSet<Widget>();
      Set<Widget> hSet = new HashSet<Widget>();
      	
      Widget a = new Widget(num1,num2);   //same or different?
      Widget b = new Widget(num1,num2);
      Widget c = new Widget(num1,num2);
      //c = b;
